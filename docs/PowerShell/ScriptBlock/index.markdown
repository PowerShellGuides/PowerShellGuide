...
* What happens when the [command](/PowerShell/Commands) starts (with the [begin block](/PowerShell/ScriptBlock/Begin-Block))
* When happens when an object comes thru the [pipeline](/PowerShell/Concepts/The-Object-Pipeline) (with the [process block](/PowerShell/ScriptBlock/Process-Block))
* When happens when the [command](/PowerShell/Commands) ends (with the [end block](/PowerShell/ScriptBlock/End-Block))
